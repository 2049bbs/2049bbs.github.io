...
> 论坛已经恢复正常，但[很有可能被共产党接管](https://2049bbs.xyz/t/4544) （`刚才发小广告的用户已经被封禁，帖子也不在垃圾站。查看受限用户列表发现此id发帖记录为0。说明2049已经有了删帖功能，并且管理员执行了封号加删帖操作` `与往常的封号文章丢垃圾站的处理原则不同`）。  
> 
> **在[确认小二安全](https://2049bbs.xyz/t/4545)前请不要访问**。
