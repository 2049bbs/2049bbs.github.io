...
comments:
    -
        ...
        content: '历史学柑仔店 网址换了 https://kamatiam.org'
    -
        authorID: 1665
    ...
    -
        ...
        content: |-
            ...
            更新一下OPML的文件 https://ufile.io/0kl20u74
    -
        authorID: 1665
        addTime: 2019-11-17T05:30:00.000Z
        content: |-
            另外推荐一款社会和政治为主题的综合RSS源 https://rss.app/feeds/M\_HfDrxWTOFxt1ljDr.xml

            ![构成](https://i.imgur.com/vslTvVm.png)

            OPML文件下载地址 https://ufile.io/1hyhmn6s
    -
        authorID: 2199
...
1.  将RSS Feed链接添加至你的RSS阅读器中 https://rss.app/feeds/M\_He7xML5MHmAF5SGt.xml
2.  也可下载包含单个博客RSS Feed的OPML文件 https://ufile.io/m1usv1lr 导入阅读器
...
https://newjrs.github.io/feeds.html
