...
comments:
    ...
    -
        ...
        addTime: 2020-02-28T17:45:00.000Z
        content: >-
            靠谱的还是建议自建。另外vpn并非设计为翻墙使用的，请尽量考虑ss/v2等平台。


            搭建教程的话可以参考：[这个教程](https://chralpha.com/outlook/get-a-stable-outlook-through-v2ray-and-cdn/)


            使用 V2ray + ws + tls 非常时期套上 CDN ，还是十分稳定的。


            一步步来，不需要太了解技术都可以做到的。


            目前我的那一台开机使用了 4 个月，仍然十分坚挺。希望能够帮到你。
    -
        authorID: 3625
