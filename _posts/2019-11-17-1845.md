...
comments:
    ...
    -
        ...
        content: >-
            @[xyz](/member/xyz) 1. 文章要说明搜索引擎排名有时候都能决定另一家公司的生死存亡。With great power
            comes great responsibility。Google似乎也像政府一样，要增加透明度、可问责。这点绝对没错。


            1. 
            文章列举的“罪证”没有表面上看起来那么邪恶。作者没有解释背后的技术原因。比如为什么要靠人工标注（contractors）选择他们喜好的排序。其实人工智能算法很大的一类是“有监督的学习”，就是从人工标注的数据中学习，没有人工标注就没有人工智能了，这是免不了的。而且Google网站上也有说明，甚至给出了他们的标准。您可以前往[这里](https://guidelines.raterhub.com/searchqualityevaluatorguidelines.pdf)查看这些指南。  
                网址：[https://www.google.com/search/howsearchworks/mission/users/](https://www.google.com/search/howsearchworks/mission/users/)
            2. 
    ...
    -
        ...
        content: >-
            ...
            > Some very big advertisers received direct advice on how to improve
            their organic search results, a perk not available to businesses
            with no contacts at Google。
    ...
    -
        ...
        content: >-
            ###
            [](#misquoted-and-misunderstood-why-many-in-the-search-community-don-t-believe-the-wsj-about-google-search)Misquoted
            and misunderstood: Why many in the search community don’t believe
            the WSJ about Google search


            [https://searchengineland.com/misquoted-and-misunderstood-why-we-the-search-community-dont-believe-the-wsj-about-google-search-325241](https://searchengineland.com/misquoted-and-misunderstood-why-we-the-search-community-dont-believe-the-wsj-about-google-search-325241)


            这篇博客说contractors只是给搜索结果评分，不会直接影像搜索排名。


            > These contractors have zero access or control over the search
            results you or I see in Google. All they do is report back to
            Google’s engineers if the search results they are looking at are
    ...
    -
        ...
        content: >-
            @[xyz](/member/xyz) #16 因为算法要不断改进，如何知道现在的算法比改进前的好而不是越改越坏呢？ 这需要测试。
            怎么测试？搜索结果的好坏，或者说对用户有用/没用这是一个主观的标准，必须由人来评分。
            这帮contractors就是负责根据Google给的评分表给搜索结果评分的。  

            最终这些评分会影响算法改进的方向。  

            google还要求这些人评分的时候要考虑自己本地区的用户会怎么想，什么内容是对本地区的人有用的。我觉得这相当于google要求这些人要代入自己本地区的“偏见”进去评分。
    -
        authorID: 2280
    ...
    -
        ...
        content: >-
            其实我比较担心济南、天津那些审查中心，他们的审查标准不公开，随意度很大。如果他们也带入本地区的偏见，那就是仅仅代表山东的见解。


            [https://terminus2049.github.io/archive/2019/04/18/Ji-nan-internet-cencored.html](https://terminus2049.github.io/archive/2019/04/18/Ji-nan-internet-cencored.html)
    -
        authorID: 2280
