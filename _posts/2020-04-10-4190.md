...
comments:
    ...
    -
        ...
        content: >-
            ...
            click结合，导入数据，直接在一个窗口看数据，等等。学R语言的话可以看看coursera上的课程，有具体的schedule，如这里：[https://www.coursera.org/learn/r-programming](https://www.coursera.org/learn/r-programming)
    -
        authorID: 2911
