...
comments:
    ...
    -
        ...
        content: '测试了一下 pangu.js，还是达不到要求，不能在链接后面自动添加空格 https://i.imgur.com/AG1JZeh.png'
    -
        authorID: 3
...
另外，推一个脚本——為什麼你們就是不能加個空格呢？（Chrome 还有相同扩展，但有脚本何必用扩展呢） (https://greasyfork.org/zh-CN/scripts/2185-為什麼你們就是不能加個空格呢) 简介：
