...
comments:
    ...
    -
        ...
        content: |-
            ...
            Europe travel ban但是不包含UK...这到底是什么鬼操作，也就是说伦敦转机就okay了?

            增加检测倒是讲半天进展缓慢的要死。

            难怪有人讽刺lucky Europeans, 连带close加美边境吧。
    -
        authorID: 2149
        addTime: 2020-03-12T03:45:00.000Z
        content: >-
            Dow (INDU) futures plunged more than 1,100 points, or 4.73%. S&P 500
            (SPX) futures fell 4.6% and Nasdaq (COMP) futures were down 5%.


            Markets in Asia were all trading sharply lower Thursday morning.
            Japan's Nikkei 225 (N225) fell 4.1%. Hong Kong's Hang Seng Index
            (HSI) was down 3.2%, while the Shanghai Composite Index (SHCOMP)
            fell 1% and South Korea's Kospi Index (KOSPI) was down 3.8%
    ...
    -
        authorID: 2149
        addTime: 2020-03-12T03:45:00.000Z
        content: "也不一定伦敦转机，也是可以在Montreal, Toronto转。\n\n总之就是不造成全球到处散播总统就是不罢休啊\U0001F644️"
    -
        authorID: 2243
