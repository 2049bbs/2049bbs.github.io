...
comments:
    ...
    -
        ...
        content: >-
            ...
            当时没过几天archive.st就恢复服务了。
            另外，archive.st需要验证谷歌的reCAPTCHA才能使用它，所以站长，在你的一键存档工具里没有办法使用它。
    -
        authorID: 4243
        addTime: 2020-04-30T04:45:00.000Z
        content: '@[小二](/member/%E5%B0%8F%E4%BA%8C) #4 请管理员注销本帐号'
date: 2020-04-30T04:45:00.000Z
category: 分享创造
---

http://206.189.252.32:12345/ 可以同时提交到多个存档服务中，并且不会保存用户提交的任何记录。

来源于 https://github.com/oduwsdl/archivenow

    archivenow --server
    

archivetelebot http://206.189.252.32:8088/ 服务会保存网址和提交时间（不保存ip也无法保存ip），会在稍后不断检测网址是否已经404。
